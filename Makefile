.PHONY: help install dev test lint format run clean docker-build docker-run smoke supertrend-assets
...
help:
	...
	@echo "  make supertrend-assets  Generate Supertrend report with asset-based filename + asset list"
